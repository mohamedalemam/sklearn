...
KNeighborsRegressorModel = KNeighborsRegressor(n_neighbors =2 , weights='uniform', #also can be : distance, or defined function 
                                               algorithm = 'ball_tree')    #also can be : ball_tree ,  kd_tree  , brute
